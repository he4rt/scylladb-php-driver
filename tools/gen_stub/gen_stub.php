...
class FileInfo {
    ...
    private function handleStatements(array $stmts, PrettyPrinterAbstract $prettyPrinter): void {
        ...
        foreach ($stmts as $stmt) {
            ...
            /* declare(strict_types=1); is harmless for arginfo generation —
               it's a parse directive for the file, not a runtime construct.
               Local vendor patch: skip it instead of erroring. */
