...
class CCM
{
    public const DEFAULT_CLUSTER_PREFIX = "php-driver";
    public const PROCESS_TIMEOUT_IN_SECONDS = 480;

    public function __construct(
        private readonly bool $isSilent = false,
        private readonly string $clusterPrefix = self::DEFAULT_CLUSTER_PREFIX,
    )
    {
