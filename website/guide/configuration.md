...
::: warning Nine directives do nothing on the scylla-rust backend
...
`cassandra.prepare_on_all_hosts`, `cassandra.prepare_on_up_or_add_host`, `cassandra.no_compact`,
`cassandra.tracing_consistency`,
