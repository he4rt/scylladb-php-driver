...
static const zend_function_entry class_Cassandra_DefaultColumn_methods[] = {
	...
	ZEND_ME(Cassandra_DefaultColumn, indexName, arginfo_class_Cassandra_DefaultColumn_indexName, ZEND_ACC_PUBLIC|ZEND_ACC_DEPRECATED)
	ZEND_ME(Cassandra_DefaultColumn, indexOptions, arginfo_class_Cassandra_DefaultColumn_indexOptions, ZEND_ACC_PUBLIC|ZEND_ACC_DEPRECATED)
	ZEND_FE_END
};
