...
PHP_METHOD(Blob, __construct) { php_driver_blob_init(INTERNAL_FUNCTION_PARAM_PASSTHRU); }
/* }}} */
        ...
        PHP_ME(Blob, __toString, arginfo_tostring, ZEND_ACC_PUBLIC)
            PHP_ME(Blob, type, arginfo_none, ZEND_ACC_PUBLIC)
                PHP_ME(Blob, bytes, arginfo_none, ZEND_ACC_PUBLIC)
                    PHP_ME(Blob, toBinaryString, arginfo_none, ZEND_ACC_PUBLIC) PHP_FE_END};

static zend_object_handlers php_driver_blob_handlers;
...
void php_driver_define_Blob() {
  ...
  php_driver_blob_handlers.get_properties = php_driver_blob_properties;
  php_driver_blob_handlers.get_gc = php_driver_blob_gc;
  php_driver_blob_handlers.compare = php_driver_blob_compare;
  php_driver_blob_ce->ce_flags |= ZEND_ACC_FINAL;
  php_driver_blob_ce->create_object = php_driver_blob_new;

  php_driver_blob_handlers.clone_obj = nullptr;
}
END_EXTERN_C()