...
static zend_result to_string(zval *result, php_driver_numeric *decimal) {
  char *string;
  int string_len;
  php_driver_format_decimal(decimal->data.decimal.value, decimal->data.decimal.scale, &string,
                            &string_len);
...
void php_driver_decimal_init(INTERNAL_FUNCTION_PARAMETERS) {
  ...
  if (Z_TYPE_P(value) == IS_LONG) {
    ...
    INVALID_ARGUMENT(value,
                     "a long, a double, a numeric string or a " PHP_DRIVER_NAMESPACE "\\Decimal");
  }
}

/* {{{ Decimal::__construct(string) */
PHP_METHOD(Decimal, __construct) { php_driver_decimal_init(INTERNAL_FUNCTION_PARAM_PASSTHRU); }
/* }}} */
                ...
                PHP_ME(Decimal, value, arginfo_none, ZEND_ACC_PUBLIC)
                    PHP_ME(Decimal, scale, arginfo_none, ZEND_ACC_PUBLIC)
                        PHP_ME(Decimal, add, arginfo_num, ZEND_ACC_PUBLIC)
                            PHP_ME(Decimal, sub, arginfo_num, ZEND_ACC_PUBLIC) PHP_ME(
                                Decimal, mul, arginfo_num, ZEND_ACC_PUBLIC)
                                PHP_ME(Decimal, div, arginfo_num, ZEND_ACC_PUBLIC) PHP_ME(
                                    Decimal, mod, arginfo_num, ZEND_ACC_PUBLIC)
                                    PHP_ME(Decimal, abs, arginfo_none, ZEND_ACC_PUBLIC) PHP_ME(
                                        Decimal, neg, arginfo_none, ZEND_ACC_PUBLIC)
                                        PHP_ME(Decimal, sqrt, arginfo_none, ZEND_ACC_PUBLIC) PHP_ME(
                                            Decimal, toInt, arginfo_none, ZEND_ACC_PUBLIC)
                                            PHP_ME(Decimal, toDouble, arginfo_none, ZEND_ACC_PUBLIC)
                                                PHP_FE_END};

static zend_object_handlers php_driver_decimal_handlers;
...
void php_driver_define_Decimal() {
  ...
  memcpy(&php_driver_decimal_handlers, zend_get_std_object_handlers(),
         sizeof(zend_object_handlers));
  php_driver_decimal_handlers.get_properties = php_driver_decimal_properties;
  php_driver_decimal_handlers.get_gc = php_driver_decimal_gc;
  php_driver_decimal_handlers.compare = php_driver_decimal_compare;
  php_driver_decimal_handlers.cast_object =
      static_cast<zend_object_cast_t>(php_driver_decimal_cast);
  php_driver_decimal_handlers.clone_obj = NULL;
}
END_EXTERN_C()