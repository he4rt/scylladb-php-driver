...
void php_driver_varint_init(INTERNAL_FUNCTION_PARAMETERS) {
  ...
  if (Z_TYPE_P(num) == IS_LONG) {
    ...
    INVALID_ARGUMENT(
        num, "a long, double, numeric string or a " PHP_DRIVER_NAMESPACE "\\Varint instance");
  }
}
/* {{{ Varint::__construct(string) */
PHP_METHOD(Varint, __construct) { php_driver_varint_init(INTERNAL_FUNCTION_PARAM_PASSTHRU); }
/* }}} */
                            ...
                            PHP_ME(Varint, mul, arginfo_num, ZEND_ACC_PUBLIC)
                                PHP_ME(Varint, div, arginfo_num, ZEND_ACC_PUBLIC)
                                    PHP_ME(Varint, mod, arginfo_num, ZEND_ACC_PUBLIC)
                                        PHP_ME(Varint, abs, arginfo_none, ZEND_ACC_PUBLIC) PHP_ME(
                                            Varint, neg, arginfo_none, ZEND_ACC_PUBLIC)
                                            PHP_ME(Varint, sqrt, arginfo_none, ZEND_ACC_PUBLIC)
                                                PHP_ME(Varint, toInt, arginfo_none, ZEND_ACC_PUBLIC)
                                                    PHP_ME(Varint, toDouble, arginfo_none,
                                                           ZEND_ACC_PUBLIC) PHP_FE_END};

static zend_object_handlers php_driver_varint_handlers;
...
void php_driver_define_Varint() {
  ...
  php_driver_varint_handlers.get_properties = php_driver_varint_properties;
  php_driver_varint_handlers.get_gc = php_driver_varint_gc;
  php_driver_varint_handlers.compare = php_driver_varint_compare;
  php_driver_varint_handlers.cast_object = php_driver_varint_cast;
  php_driver_varint_handlers.clone_obj = NULL;
}
END_EXTERN_C()