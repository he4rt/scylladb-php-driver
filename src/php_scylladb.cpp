...
ZEND_DLEXPORT zend_module_entry *get_module() { return &php_scylladb_module_entry; }
END_EXTERN_C()
...
int php_le_php_scylladb_cluster() { return le_php_scylladb_cluster_res; }
...
int php_le_php_scylladb_session() { return le_php_scylladb_session_res; }
static void php_scylladb_session_dtor(zend_resource* rsrc) {
  auto *psession = (php_scylladb_psession *)rsrc->ptr;
...
int php_le_php_scylladb_prepared_statement() { return le_php_scylladb_prepared_statement_res; }
static void php_scylladb_prepared_statement_dtor(zend_resource* rsrc) {
  auto *preparedStmt = (php_scylladb_pprepared_statement *)rsrc->ptr;
...
static void php_scylladb_log_cleanup() {
...
static void php_scylladb_log_initialize() {
