...
static int
build_from_array(php_driver_execution_options* self, zval* options, int copy)
{
...
int
php_driver_execution_options_build_local_from_array(php_driver_execution_options* self, zval* options)
{
