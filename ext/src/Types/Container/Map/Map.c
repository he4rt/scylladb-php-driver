...
PHP_METHOD(Map, __construct)
{
  ...
  } else if (Z_TYPE_P(key_type) == IS_OBJECT && instanceof_function(Z_OBJCE_P(key_type), php_driver_type_ce)) {
  ...
  } else if (Z_TYPE_P(value_type) == IS_OBJECT && instanceof_function(Z_OBJCE_P(value_type), php_driver_type_ce)) {
